...
const secondaryFeatures = [
  {
    ...
    href: 'https://superbowlpoolsite.com/about-us', // Placeholder, update as needed
    icon: CloudArrowUpIcon,
  },
  {
    name: 'Entertainment',
    ...
    href: 'https://superbowlpoolsite.com/how-it-works', // Placeholder, update as needed
    icon: LockClosedIcon,
  },
  {
    ...
    href: 'https://superbowlpoolsite.com/fundraising', // Placeholder, update as needed
    icon: ArrowPathIcon,
  },
]
const featuredTestimonial = {
  body: 'sbpsentertainment has created a fun and engaging platform for us to connect with our family and friends during the Super Bowl. It\'s a perfect way to make the game even more exciting!',
  author: {
    name: 'SuperBowlPoolSite.com User',
    handle: 'sportsfan',
    imageUrl:
...
const testimonials = [
  [
    [
      {
        body: 'The ease of use and reliability is unmatched. Our annual contest has become a tradition thanks to this amazing platform.',
        author: {
      ...
      {
        body: 'Smooth, bug-free, and a blast to use. It\'s clear the team is passionate about what they do.',
        author: {
          name: 'Happy Participant',
      ...
      {
        body: 'We raised so much for our team this year. The platform made it so easy to manage everything from a single dashboard.',
        author: {
          name: 'Fundraising Organizer',
          handle: 'driesvincent',
          imageUrl:
    ...
    [
      {
        body: 'User-friendly interface and robust features. I highly recommend it to anyone looking to run a contest.',
        author: {
          name: 'Lindsay Walton',
      ...
      {
        body: 'The best site for online squares. Period. Everything just works, and the support is fantastic.',
        author: {
          name: 'Courtney Henry',
  ...
  [
    [
      {
        body: 'The worlds longest running website for a reason. They know what they are doing.',
        author: {
          name: 'Tom Cook',
          handle: 'tomcook',
          imageUrl:
      ...
      {
        body: 'The templates and customization options are incredible. We were able to make it our own.',
        author: {
    ...
    [
      {
        body: 'The app is great, but the service is even better. They are always on top of things.',
        author: {
      ...
      {
        body: 'Finally, a platform that understands the user. The experience is flawless.',
        author: {
          name: 'Floyd Miles',
          handle: 'floydmiles',
          imageUrl:
      ...
      {
        body: 'I appreciate the free version of the site and how it still gets the job done without any issues. The paid version is worth every penny though.',
        author: {
          name: 'Emily Selman',
          handle: 'emilyselman',
          imageUrl:
...
const footerNavigation = {
  solutions: [
    { name: 'SuperBowlPoolSite', href: 'https://superbowlpoolsite.com' },
    { name: 'All Products', href: '#solutions' }, // Placeholder for future products
  ],
  support: [
    { name: 'Contact Us', href: 'mailto:support@sbpsentertainment.com' },
  ...
  social: [
    {
      name: 'Facebook',
      href: 'https://facebook.com/sbpsentertainment',
    ...
    {
      name: 'X',
      href: 'https://twitter.com/sbpsentertainment',
      icon: (props: SVGProps<SVGSVGElement>) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
    ...
    {
      name: 'GitHub',
      href: 'https://github.com/sbpsentertainment',
      icon: (props: SVGProps<SVGSVGElement>) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
    ...
    {
      name: 'YouTube',
      href: 'https://youtube.com/@sbpsentertainment',
      icon: (props: SVGProps<SVGSVGElement>) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
  ...
  return (
    <div className="bg-white dark:bg-gray-900">
      ...
      <header className="absolute inset-x-0 top-0 z-50">
        <nav aria-label="Global" className="flex items-center justify-between p-6 lg:px-8">
          ...
          <div className="hidden lg:flex lg:flex-1 lg:justify-end">
            <a href="https://superbowlpoolsite.com" className="text-sm/6 font-semibold text-gray-900 dark:text-white">
      ...
      <main>
            ...
            <div className="mx-auto max-w-2xl lg:mx-0 lg:flex-auto">
              <div className="flex">
                <div className="relative flex items-center gap-x-4 rounded-full bg-white px-4 py-1 text-sm/6 text-gray-600 ring-1 ring-gray-900/10 hover:ring-gray-900/20 dark:bg-white/5 dark:text-gray-300 dark:ring-white/10 dark:hover:ring-white/20">
                  ...
                  <a href="https://superbowlpoolsite.com" className="flex items-center gap-x-1">
        ...
        {/* Feature section */}
        <div id="features" className="mx-auto mt-32 max-w-7xl sm:mt-56 sm:px-6 lg:px-8">
            ...
            <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-center lg:gap-y-0">
              <div className="lg:row-start-2 lg:max-w-md">
                <h2 className="text-3xl font-semibold tracking-tight text-balance text-white sm:text-4xl">
                  Our Mission: Building Fun and Engaging Digital Platforms.
                </h2>
                <p className="mt-6 text-lg/8 text-gray-300">
                  We are a dedicated team of technologists and entertainment enthusiasts focused on creating digital experiences that foster community and fun. We believe that technology should be simple, reliable, and bring people together.
                </p>
              </div>
              <img
                alt="Super Bowl Pool Site Screenshot"
        ...
        <div id="testimonials" className="relative isolate mt-32 sm:mt-56 sm:pt-32">
          <svg
            aria-hidden="true"
          ...
          <div className="relative">
            ...
            >
              <div
                ...
                className="ml-[max(50%,38rem)] aspect-1313/771 w-328.25 flex-none origin-top-right rotate-30 bg-linear-to-tr from-[#ff80b5] to-[#9089fc]"
              />
            </div>
            <div
              aria-hidden="true"
            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
              <div className="mx-auto max-w-2xl text-center">
                ...
                <p className="mt-2 text-4xl font-semibold tracking-tight text-balance text-gray-900 sm:text-5xl dark:text-white">
                  Trusted by thousands of amazing contest creators
                </p>
              </div>
          ...
          <div className="xl:grid xl:grid-cols-3 xl:gap-8">
            ...
            <div className="mt-16 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
              <div className="md:grid md:grid-cols-2 md:gap-8">
                <div>
                  <h3 className="text-sm/6 font-semibold text-gray-900 dark:text-white">Our Sites</h3>
